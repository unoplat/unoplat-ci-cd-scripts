...
alertmanager:
  ...
  config:
    ...
    - name: 'discord-webhook'
      webhook_configs:
        - url: 'https://discord.com/api/webhooks/1189464833301684316/4TiVlF6ZtZpUU_0wii6redAHXo1XBDsM3fqzupa5tKSCM8GJ2qR6fDT0wJ3dNH3OBS4j'
          send_resolved: true
    templates:
...
grafana:
  ...
  additionalDataSources: 
    - name: unoplat-loki
      type: loki
      url: http://unoplat-observability-loki-stack.unoplat-observability:3100
      access: proxy
      version: 1
      isDefault: false
      editable: true
...
```
{
    ...
    "ghcr.io/prometheus-community/windows-exporter:0.22.0": [
        "prometheus-windows-exporter.image.tag"
    ],
    "quay.io/prometheus-operator/admission-webhook:v0.70.0": [
